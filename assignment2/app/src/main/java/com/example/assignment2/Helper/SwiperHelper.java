...
public abstract class SwiperHelper extends ItemTouchHelper.SimpleCallback
{
    ...
    public SwiperHelper(Context context, RecyclerView recyclerView, int buttonWidth)
    {
    ...
    public float getSwipeThreshold(RecyclerView.ViewHolder viewHolder){ return swipeThreshold;}
